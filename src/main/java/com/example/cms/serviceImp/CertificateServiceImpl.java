...
@Service
public class CertificateServiceImpl implements DynamicCertificateService {
    ...
    public String generateCertificateHtml(Registration registration, Event event, String memberName) {
        ...
        // Format date - Convert LocalDate to String
        String formattedDate = "TBD";
        if (event.getEventDate() != null) {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd MMMM, yyyy");
            formattedDate = event.getEventDate().format(formatter);
        }
        ...
        String html = template
                .replace("{{studentName}}", memberName != null ? memberName : "")
                .replace("{{eventName}}", event.getEventName() != null ? event.getEventName() : "")
